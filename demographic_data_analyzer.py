...
def calculate_demographic_data(print_data=True):
    ...
    num_bachelors = df[df["education"] == "Bachelors"].size
    total_num = df.size
    ...
    non_percentaje_higher = higher_education[higher_education.salary == ">50K"].size
    non_percentaje_lower = lower_education[lower_education.salary == ">50K"].size
  
    higher_education_rich = round(non_percentaje_higher / higher_education.size * 100, 1)
    lower_education_rich = round(non_percentaje_lower / lower_education.size * 100, 1)
